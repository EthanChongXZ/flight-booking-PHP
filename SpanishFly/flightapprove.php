...
<head>
	<title>SpanishFly - Crew Module</title>
    <meta charset="utf-8">
...
$sql = "UPDATE flight SET status='Approved' WHERE number='$_GET[number]'";
}
else{
$sql = "DELETE FROM flight WHERE number = '$_GET[number]'";
}
...
echo "<p><center>Flight approved</center></p>";
?>
